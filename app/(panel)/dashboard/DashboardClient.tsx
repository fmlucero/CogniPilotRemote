...
// HU-11/HU-26 — el FleetMap vive en components/ y maneja su propio polling
//             del endpoint /api/realtime/positions. Acá sólo lo montamos.
...
export default function DashboardClient({
  ...
  // El mapa de flota vive en <FleetMap /> — encapsula polling, Leaflet init y
  // sync de markers. Reusado en /supervisor (HU-26).
    ...
    <>
      ...
      <div className="grid">
        ...
        <div className="col-7 col-stack">
          <FleetMap title="🗺️ Mapa de la flota" />
